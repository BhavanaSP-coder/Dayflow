...
def get_my_payroll(
    ...
    return controller.get_my_payroll(db, current_user, month, year, skip, limit)
...
def list_all_payroll(
    ...
    return controller.list_all_payroll(db, month, year, skip, limit)
...
def get_employee_payroll(
    ...
    return controller.get_employee_payroll(
...
def upsert_payroll(
    ...
    """
    result, created = controller.upsert_payroll(
