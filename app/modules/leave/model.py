...
class LeaveRequest(Base):
    ...
    # --- INTEGRATION POINT (Person 1) ---------------------------------------
    # Plain indexed column for now, because Person 1's employee table does not
    # exist yet. Once it does, this becomes a real foreign key -- change to:
